...
public class ExampleEmployee {
    ...
    public static void main(String[] args) {
        ...
        //所有salary大于8000
        List<Employee> employeeLists =  employeeList.stream().filter((Employee e) -> e.getSalary() > 8000).collect(Collectors.toList());
        ...
        //按照名字的升序列出员工信息
        List<Employee> sortEmployeeByName = employeeList.stream().sorted(Comparator.comparing(Employee::getName)).collect(Collectors.toList());
